    ...
    <div class="gray-bg">
        ...
        <div class="page-xjk-top-assets-info">
           ...
           <div class="bottom">
               <dl class="item-list clearfix">
                   <dd>
                       <span class="fs-12">小金库</span>
                       <span class="fs-18">{{userAccountInfoVo.currBal}}</span>
                       <span class="fs-12"></span>
                    </dd>
                    <dd v-if="this.regularProNum!=0">
                       <span class="fs-12">定期理财</span>
                       <span class="fs-18">{{regularProTotal}}</span>
                       <span class="fs-12">{{regularProNum}}笔投资中</span>
                    </dd>
                    <dd v-if="this.fixedProNum!=0">
                       <span class="fs-12">固定期理财</span>
                       <span class="fs-18">{{fixedProTotal}}</span>
                       <span class="fs-12">{{fixedProNum}}笔投资中</span>
                    </dd>
               </dl>
           </div>
        </div>
        <div class="page-wdcc-middle-tag">
            <div class="tag">
                ...
                <router-link class="more" to="/transactionDetail">
                查看交易明细
            ...
            <dd v-for="(v,i) in totalAllList" :key="i" @click="linkToWarehouseDetail(v)">
                <div class="header">
                    <div class="title">
                        ...
                        <span class="tag" v-if="pageData.typeCode==0">投资中</span>
                        <span class="tag" v-if="pageData.typeCode==1">已赎回</span>
                    </div>
    ...
    export default {
        ...
        methods:{
            ...
            linkToWarehouseDetail(v){
                ...
                if(v.fixedTerm==2){
                    if(this.pageData.typeCode==0){
                    this.$router.push({name:"myWarehouseDetail1", params:{v:v}})
                    }else{
                    this.$router.push({name:"myWarehouseDetail2", params:{v:v}})
                    }
                }else if(v.fixedTerm==1){
                    if(this.pageData.typeCode==0){
                    this.$router.push({name:"myWarehouseDetail3", params:{v:v}})
                    }else{
                    this.$router.push({name:"myWarehouseDetail4", params:{v:v}})
                    }
                }
            },
            getInfo(){
