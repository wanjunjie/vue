    ...
    <div class="gray-bg">
        ...
        <div class="top-pay-check">
            ...
            <div class="title-box">
             ...
             <div class="num" v-if="boolState==true">{{this.totalMoney}}</div>
             <div class="num" v-if="boolState==false">****</div>
             <router-link  to="/myWarehouse" class="link" >查看我的持仓</router-link>

             <div class="stop-prompt">
                 <div class="show-btn" @click="toggleFlag" v-if="empStatus===EMP_STATUS.STOP">停用提示</div>
                 <div class="content" :hidden="addFlag%2==0">
                     <span class="i"></span>
                     <div class="info">
                            <p>账号停用状态时，将无法进行活期理财的充值、期限理财申购，定期理财到期不再续投，自动赎回至活期。</p>
                            <p>不影响活期提现、期限产品转活期产品、资产查询等操作。如有疑问请联系企业管理员。</p>
                     </div>
                     <div class="img"><img src="@/assets/img/tx.png"></div>
                 </div>
                 <div class="bg" :hidden="addFlag%2==0" @click="toggleFlag"></div>
             </div>
        ...
        <div class="pay-check-middle-box">
            <div class="title">
                ...
                <router-link class="info" to="/myCurrentAcct">
                    <span>详情</span>
                    <span class="i">
                        <svg class="icon" aria-hidden="true">
            ...
            <a class="b-btn" href="javascript:void(0);" v-if="queryPower.cz!=='0'&&empStatus!==EMP_STATUS.STOP" @click="recharge">充值</a>
        </div>
        ...
        <div class="pay-check-investment-bottom">
            <dl class="sub-list" v-if="empStatus!==4">
                ...
                <dd>
                    <router-link :to="{name:'newRegularWealth',params:{index:0}}" class="bottom-more-btn" >更多产品</router-link>
                </dd>
            </dl>
        </div>
        <div class="pay-check-investment-bottom">
            <dl class="sub-list" v-if="empStatus!==4">
                ...
                <dd>
                    <router-link :to="{name:'newRegularWealth',params:{index:1}}" class="bottom-more-btn" >更多产品</router-link>
                </dd>
            </dl>
        </div>
    </div>
