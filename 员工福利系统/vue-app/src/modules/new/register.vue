    ...
    <div class="app-wrap pb-200">
        ...
        <dl class="form-list mt-35">
            ...
            <dd>
                ...
                <div class="input-box">
                    <input ref="password" v-model="passwordIhp" type="password" placeholder="请输入6位钱包支付密码">
                </div>
            </dd>
        </dl>
        ...
        <div class="btn-box mt-35">
            <a @click="login" class="btn btn-blue" href="javascript:void(0)">下一步，验证卡信息</a>
        </div>
...
<script>
    ...
    import eebH5Agreement from '../../components/eebH5Agreement'
