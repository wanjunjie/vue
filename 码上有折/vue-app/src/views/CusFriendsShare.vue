...
<div>
    <div class="img invite-friends-img">
        <router-link class="a" to="/cusMyInvitation">我的分享</router-link>
    ...
    <div class="img invite-friends-img">
        <a @click="share = true" class="btn-1" href="javascript:void(0)">立即邀请</a>
        <a @click="getQrCode()" class="btn-2" href="javascript:void(0)">面对面邀请</a>
...
export default {
    ...
    methods:{
        getQrCode(){
            this.$util.postRequest('/walletpn/cusInvite/f2fInvite',{tokenId:this.tokenId})
            .then( res => {
                console.log(res)
